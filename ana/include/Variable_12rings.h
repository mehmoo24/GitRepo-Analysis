...
class Variable2D : public PlotUtils::Variable2DBase<NUKECC_ANA::CVUniverse> {
 ...
 public:
  ...
  HW2D ring_mresp[12];
  HW2D ring_m_selected_Migration[12];

  HW2D ring_m_selected_mc_reco[12];
  HW2D ring_reco_QE[12];
  HW2D ring_reco_2p2h[12];
  HW2D ring_reco_trueDIS[12];
  HW2D ring_reco_softDIS[12];
  HW2D ring_reco_other[12];
  HW2D ring_reco_resonant[12];
  HW2D ring_true_QE[12];
  HW2D ring_true_2p2h[12];
  HW2D ring_true_trueDIS[12];
  HW2D ring_true_softDIS[12];
  HW2D ring_true_other[12];
  HW2D ring_true_resonant[12];
  HW2D ring_signal_purityNum[12];
  HW2D ring_bkg_total[12];
  HW2D ring_ANCC[12];
  HW2D ring_ANNC[12]; 
  HW2D ring_NCC[12];
  HW2D ring_NNC[12];
  HW2D ring_ANNCCNCother[12];
  HW2D ring_h_background_subtracted_mc[12];
  HW2D ring_h_background_mc_scale[12];
  HW2D ring_h_background_subtracted_data[12];
  HW2D ring_m_selected_data_reco[12];
  HW2D ring_m_selected_truth_reco[12];
//  HW2D ring_m_selected_Migration[12];
//  HW2D ring_mresp[12];
