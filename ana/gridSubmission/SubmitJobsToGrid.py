...
def writeEventLoop(mywrapper,outdir,playlist,pdg,filename):
   ...
   # mywrapper.write("./runEventLoop_BEAMCoord . "+playlist+" "+pdg+" "+str(filename))
    mywrapper.write("\n")
...
def writeSetups(mywrapper,basedir):
   ...
   # mywrapper.write("source /cvmfs/minerva.opensciencegrid.org/minerva/setup/setup_minerva_products.sh\n")
    ...
    mywrapper.write("spack load fife-utils\n")
    ...
    mywrapper.write("export NUKECCSRCROOT=${CONDOR_DIR_INPUT}/exp/minerva/app/users/mmehmood/MAT_AL9/GitRepo-Analysis/NUKECCSRC\n")
    mywrapper.write("export NUKECCSRC_ANA=${NUKECCSRCROOT}/ana_common\n")
    mywrapper.write("export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:${CONDOR_DIR_INPUT}/exp/minerva/app/users/mmehmood/MAT_AL9/GitRepo-Analysis/NUKECCSRC/ana_common/src\n")

    # source bash script
    mywrapper.write("cd "+topdir+"\n")
    mywrapper.write("source setup_GRID.sh\n")

    mywrapper.write("export PYTHONPATH=/exp/minerva/app/users/mmehmood/MAT_AL9/MAT-MINERvA/python:/exp/minerva/app/users/mmehmood/MAT_AL9/MAT-MINERvA/python/PlotUtils\n")
...
def writeTarballProceedure(mywrapper,tag,basedir):
    ...
    mywrapper.write("cd $CONDOR_DIR_INPUT\n")
    mywrapper.write("export MINERVA_PREFIX=${CONDOR_DIR_INPUT}/exp/minerva/app/users/mmehmood/MAT_AL9/opt\n")
...
valid_stages=["eventLoop", "migration", "efficiency", "all", "closure"]
