...
virtual double GetReco_trk_end_x() const;
virtual double GetReco_trk_end_y() const;
...
virtual bool IsInHexagonSendCoord(double x, double y, double apothem=850.) const;
virtual bool IsInCircleSendCoord(double x, double y, double radius) const;
virtual double GetTrueRingBeamCoord() const;
virtual double GetRingBeamCoord() const;
virtual double GetHexRingTrue() const;
virtual double GetHexRing() const;
...
virtual double  GetLongitudinalMomentumWRTBeam( double px, double py, double pz, double bias=0.0 ) const;
...
double virtual GetVertexX() const;
double virtual GetVertexY() const;
double virtual GetVertexZZ() const;
double virtual GetVertexXTrue() const;
double virtual GetVertexYTrue() const;
double virtual GetVertexZZTrue() const;

double virtual GetMinosR() const;
double virtual GetMinosRTrue() const;

double virtual GetVertexXBeam() const;
double virtual GetVertexYBeam() const;
double virtual GetVertexZZBeam() const;
double virtual GetVertexXTrueBeam() const;
double virtual GetVertexYTrueBeam() const;
double virtual GetVertexZZTrueBeam() const;
