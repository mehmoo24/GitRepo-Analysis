...
namespace NUKECC_ANA
{
  ...
  // MINOS Cuts
  const double MIN_MINOS_CURVE = 5.0; //original: 5.0
...
//  const double MAX_THETA_MU = 17.0; // return to 20, only running a test!
//  const double MAX_RECO_THETA_MU = 17.0; //return to 20, only running a test!
...
namespace Analysis{ 
  const std::string NukeCC = "MasterAnaDev";
  //const std::string NukeCC = "CCQENu"; //change back to MasterAnaDev 
}
