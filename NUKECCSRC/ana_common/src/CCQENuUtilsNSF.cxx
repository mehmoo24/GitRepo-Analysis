...
{ 
  ...
  MinervaUniverse::SetNuEConstraint(useFluxConstraint);
...
void CCQENuUtilsNSF::getPOT(double& total_pot_data,double& total_pot_mc){
     ChainWrapper *chain_mc =  GetChainWrapperMCPointer(MinervaUniverse::GetPlaylist(),"Meta");
     ChainWrapper *chain_data = GetChainWrapperDataPointer(MinervaUniverse::GetPlaylist(),"Meta");
